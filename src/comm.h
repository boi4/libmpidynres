...
enum {
  ...
  //MPIDYNRES_TAG_NUM_PSETS,  // session_tag
  //MPIDYNRES_TAG_NUM_PSETS_INFO_SIZE,
  //MPIDYNRES_TAG_NUM_PSETS_INFO,
  //MPIDYNRES_TAG_NUM_PSETS_ANSWER,  // int, -1 if error

  //MPIDYNRES_TAG_NTH_PSET,         // session_tag, info?, int
  //MPIDYNRES_TAG_NTH_PSET_INFO_SIZE,
  //MPIDYNRES_TAG_NTH_PSET_INFO,
  //MPIDYNRES_TAG_NTH_PSET_ANSWER,  // size, name
