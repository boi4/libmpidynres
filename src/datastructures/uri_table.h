...
/**
 * @brief      A MPIDYNRES_uri_table holds uri->cr_set mappings (both by reference)
 */
 ...
 */
void MPIDYNRES_uri_table_add_cr_set(MPIDYNRES_uri_table *table,
                                 MPIDYNRES_cr_set *i_set,
...
/*
 * Remove uri+cr_set from table, false if not in there
 */
